...
function App() {
  ...
  return (
    <div className="bg-grey-800 flex items-center w-screen h0screen py-10">
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        <div className="form-container">
          ...
          <div className="flex flex-col items-center justify-center h-full">
            ...
            >
              <input
                className="relative rounded-xl py-2 px-3 w-2/3 bg-opacity-60 text-white placeholder-gray-200"
                onChange={handleChange}
                required
              />
              <button type="submit" className="z-10 ">
                <i
                  className="fa fa-search text-white ml-10 border-1 my-auto z-10 cursor-pointer p-3"
                  aria-hidden="true"
